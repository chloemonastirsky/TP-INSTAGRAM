...
const Profile = ({ posts, onSelectPost }) => {
  ...
  return (
    <div className="profile-container">
      ...
      <header className="profile-header">
        ...
        <section className="profile-info">
          ...
          <ul className="profile-stats">
            ...
            <li><strong>{userProfile.followers}</strong> seguidores</li>
            <li><strong>{userProfile.following}</strong> seguidos</li>
          </ul>
      ...
      {/* Sección 2: Grilla de Publicaciones */}
